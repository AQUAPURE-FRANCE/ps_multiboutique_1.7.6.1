...
{if isset($nodecontent.products) && $nodecontent.products}
	...
	{/if}
 <div class="products slider_carousel horizontal_mode block{if $nodecontent.line_lg} lady_load_img{/if}" data-filter-carousel="{$nodecontent.line_md},{$nodecontent.line_sm},{$nodecontent.line_xs},{$nodecontent.ap},1,{$nodecontent.dt},{$nodecontent.ar},5000,{$nodecontent.line_ms}">
 <div class="row">
