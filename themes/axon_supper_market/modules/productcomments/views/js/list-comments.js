...
jQuery(document).ready(function () {
  ...
  function confirmCommentAbuse(commentId) {
	...
	$('a[href="#product-comment-tab"]').click(function(){
		$('.block-tabs-btn .tabs-btn').removeClass('active');
		$('.tabs-keeper .container-tabs').removeClass('active').css('display','none');
		$('a[href="#product-comment-tab"]').addClass('active');		
		$('.block-tabs-btn #product-comment-tab').addClass('active');
		$('.tabs-keeper #product-comments-tab').addClass('active').css('display','block');
	});
