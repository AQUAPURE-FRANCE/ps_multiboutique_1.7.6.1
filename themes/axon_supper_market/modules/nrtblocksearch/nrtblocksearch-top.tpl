...
<div id="search_block_top" class="dropdown js-dropdown sticky_top">
	<div class="current pf pf-magnify expand-more" data-toggle="dropdown"></div>
		   ...
		   <div class="nrt-search {if $NRTSEARCH_SHOW_CAT != 1} no-show-cat {/if}">
		    	<form method="get" action="{$link->getPageLink('search')|escape:'html'}" id="searchbox" data-search-controller-url="{$link->getPageLink('search')|escape:'html'}">
		            <input type="hidden" name="controller" value="search" />
		                ...
		                <input class="search_query form-control" type="text" id="search_query_top" name="s" value="{$search_query}"  placeholder="{l s='Search for products...'}" />
		                <button type="submit" name="submit_search" class="btn button-search">
		                    <span class="pf pf-magnify"></span>
		                </button>
		    	</form>
