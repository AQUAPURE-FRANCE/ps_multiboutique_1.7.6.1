  ...
  <div class="currency-selector dropdown js-dropdown">
    	<span>{l s="Currency: "}</span><span class="expand-more _gray-darker" data-toggle="dropdown">
    	{$currency.sign}{$current_currency.iso_code}<i class="fa fa-angle-down"></i></span>
