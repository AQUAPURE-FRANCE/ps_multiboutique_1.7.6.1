{extends file=$layout_tagpost}
{block name='head_seo'}
    <title>{$meta_title} : {l s='Posts with'} {$tag} {l s='Tag'}</title>
{/block}
        ...
        <nav class="breadcrumb">
            <div class="container">
                <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                    <li  class="title_large title_font hidden-md-down">{l s='Posts with '} "{$tag}" {l s='tag'}</li>
                    ...
                    <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <span itemprop="name" style="text-transform: uppercase">{$tag}</span>
                    </li>
                </ol>
            </div>
        </nav>
