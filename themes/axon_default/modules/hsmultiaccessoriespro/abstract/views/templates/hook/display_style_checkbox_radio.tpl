    ...
    {foreach from=$accessories_groups[$group.id_accessory_group] item=product key=key}
        ...
        <tr class="clearfix"> 
            ...
            <td>
                ...
                {elseif $product.is_available_for_order && $accessory_configuration_keys.HSMA_SHOW_ICON_OUT_OF_STOCK}
