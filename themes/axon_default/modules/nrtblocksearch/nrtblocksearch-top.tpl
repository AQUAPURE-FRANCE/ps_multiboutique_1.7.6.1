...
<div id="_desktop_search">
   <div class="nrt-search {if $NRTSEARCH_SHOW_CAT != 1} no-show-cat container{/if}">
    	<form method="get" action="{$link->getPageLink('search')|escape:'html'}" id="searchbox" data-search-controller-url="{$link->getPageLink('search')|escape:'html'}">
            ...
            <input type="hidden" name="controller" value="search" />
                <div class="input-group-btn search_filter {if $NRTSEARCH_SHOW_CAT == 1} hidden{/if}">
   ...
   <div class="search-close-button fa"> × </div>
</div>
<!-- /Block search module TOP -->
