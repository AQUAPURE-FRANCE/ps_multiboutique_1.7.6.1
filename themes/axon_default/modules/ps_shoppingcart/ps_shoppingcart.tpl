...
<div class="box-item">
          ...
          <div class="cart-item-product-right">
	          <a href="{$product.url}">{$product.name}</a>
          	  <div class="product-name-ajax">
              	<span class="qtt-ajax">{$product.quantity} x </span>
  ...
  <div class="buttons">
	<a href="{$cart_url}" class="aqua-button with-icon view-cart"><i class="pf pf-view-basket"></i> {l s='View Cart' d='Shop.Theme.Actions'}</a>
	<a href="{$urls.pages.order}" class="aqua-button with-icon checkout"><i class="pf pf-checkout"></i> {l s='Proceed to checkout' d='Shop.Theme.Actions'}</a>
  </div>
</div>
</div>
