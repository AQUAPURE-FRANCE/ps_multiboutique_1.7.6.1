...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
	...
	<tr class="top-header">
		...
		<th width="40%"></th>
		<th class="header" width="20%">{l s='Qty' d='Shop.Pdf' pdf='true'}</th>
		{if isset($layout.before_discount)}
			<th class="header" width="{$layout.unit_price_tax_excl.width}%">{l s='Base price' d='Shop.Pdf' pdf='true'} {l s='(Tax excl.)' d='Shop.Pdf' pdf='true'}</th>
		{/if}
		<th class="header-right" width="20%">{l s='Unit Price' d='Shop.Pdf' pdf='true'} {l s='(Tax excl.)' d='Shop.Pdf' pdf='true'}</th>		
		<th class="header-right" width="20%">{l s='Total' d='Shop.Pdf' pdf='true'} {l s='(Tax excl.)' d='Shop.Pdf' pdf='true'}</th>
	</tr>
	<tr>
		<th class="product" colspan="4">{l s='Product' d='Shop.Pdf' pdf='true'}</th>
	</tr>
	...
	<!-- SHIPPING -->
	<tr>
		<th class="product" colspan="4">{l s='Shipping' d='Shop.Pdf' pdf='true'}</th>
	</tr>
	<tr class="shipping">
		<td class="product">{$carrier->name}</td>
		<td class="product center">1</td>
		<td class="product right">{displayPrice currency=$order->id_currency price=$footer.shipping_tax_excl}</td>
		<td class="product right">{displayPrice currency=$order->id_currency price=$footer.shipping_tax_excl}</td>
	</tr>
	<!-- END SHIPPING -->
	{/if}
	...
	<tr class="discount">
		<th class="reduction" colspan="4">{l s='Discounts' d='Shop.Pdf' pdf='true'}</th>
	</tr>
	{/if}
