    ...
    <tr>
        ...
        <td class="dropdown-image">
            <div class="accessory_img product-cover">
                ...
                {/if}
                    <img class="product_img_link accessory_img_link hsma-js-qv-product-cover accessory_image_{$group.id_accessory_group|escape:'htmlall':'UTF-8'}"  src="" width="45" height="45" title="" alt="" itemprop="image">
                {if !$accessory_configuration_keys.HSMA_APPLY_FANCYBOX_TO_IMAGE}
                    </a>
                {/if}
                {if $accessory_configuration_keys.HSMA_APPLY_FANCYBOX_TO_IMAGE}
