    ...
    public static function getAccessoriesByGroups(array $id_groups, array $id_products, $active = false, $id_lang = null, $include_out_of_stock = true, $buy_together_check = false)
    {
        ...
        if (!empty($records)) {
            ...
            foreach ($records as $key => &$record) {
                ...
                if ($buy_together_check) {
                    $record['is_available_buy_together'] = self::isAvailableBuyTogether($buy_together, $record['required'], $record['is_available_for_order'], $record['id_accessory_group'], $record['id_product']);
                } else {
