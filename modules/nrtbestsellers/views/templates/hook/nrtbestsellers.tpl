...
<div class="col-xs-12 no-padding-left-right {if isset($nodecontent.ar) && $nodecontent.ar ==0}arrows_center{elseif isset($nodecontent.ar) && $nodecontent.ar ==1}arrows_oncolum{/if}">
