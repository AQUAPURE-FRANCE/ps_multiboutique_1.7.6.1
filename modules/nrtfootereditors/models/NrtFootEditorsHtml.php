...
class NrtFootEditorsHtml extends ObjectModel
{
	public $title;
	public $html;
	...
	public function add($autodate = true, $null_values = false)
	{
		...
		$res &= Db::getInstance()->execute('
			INSERT INTO `'._DB_PREFIX_.'nrtfooteditors_html` (`id_html`, `id_shop`)
	...
	public function delete()
	{
		...
		$tab = new NrtFootEditorsHtml((int)$this->id);

		$res &= Db::getInstance()->execute('
			DELETE FROM `'._DB_PREFIX_.'nrtfooteditors_html`
	...
	public static function getHtmls()
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			FROM '._DB_PREFIX_.'nrtfooteditors_html hs
			LEFT JOIN '._DB_PREFIX_.'nrtfooteditors_htmlc hss ON (hs.id_html = hss.id_html)
			LEFT JOIN '._DB_PREFIX_.'nrtfooteditors_htmlc_lang hssl ON (hs.id_html = hssl.id_html)
