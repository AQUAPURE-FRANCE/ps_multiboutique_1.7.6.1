...
$(document).ready(function(){
            ...
            if($(this).attr('data-id')=='preview')
            {
                ...
                $.ajax({
        			...
        			success: function(jsonData)
        			{
                          ...
                          {
          			           $('.ets_ctf_tab.preview').html(jsonData.form_html);
   ...
   {
        if($('input[name="ETS_CTF7_ENABLE_RECAPTCHA"]:checked').val()==1)
            $('.form-group.form_group_contact.google2').show();
        else
            $('.form-group.form_group_contact.google2').hide();
   }
   ...
   $(document).on('click','input[name="ETS_CTF7_ENABLE_RECAPTCHA"]',function(){
        if($('input[name="ETS_CTF7_ENABLE_RECAPTCHA"]:checked').val()==1)
            $('.form-group.form_group_contact.google2').show();
        else
            $('.form-group.form_group_contact.google2').hide();
