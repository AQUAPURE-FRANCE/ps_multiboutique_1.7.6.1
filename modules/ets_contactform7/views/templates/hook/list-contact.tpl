    ...
    <form id="form-contact" class="form-horizontal clearfix products-catalog" action="{$link->getAdminLink('AdminContactFormContactForm',true)|escape:'html':'UTF-8'}" method="post">
        ...
        <div class="panel col-lg-12">
            <div class="panel-heading">
                 ...
                 <span class="badge">{count($contacts)|intval}</span>
                            ...
                            <th class="ctf_message">
                                <span class="title_box">
                                    <select class="form-control" name="save_message">
                                        <option value="">---</option>
                                        <option value="1" {if isset($values_submit.save_message) && $values_submit.hook==1} selected="selected"{/if}>{l s='Yes' mod='ets_contactform7'}</option>
                                        <option value="0" {if isset($values_submit.save_message) && $values_submit.hook==0} selected="selected"{/if}>{l s='No' mod='ets_contactform7'}</option>
                                    </select>
                                </span>
                            </th>
                            <th class="ctf_active">
                            ...
                            {foreach from=$contacts item='contact'}
                                <tr id="formcontact_{$contact.id_contact|intval}">
                                    ...
                                    <td class="ct_view text-center">
                                        ...
                                        {*<a target="_blank" href="{$link->getAdminLink('AdminContactFormStatistics')|escape:'html':'UTF-8'}&id_contact={$contact.id_contact|intval}">
                                    ...
                                    <td class="text-center ctf_message">
                                        {if $contact.save_message}
                                            <a title="{l s='Disable' mod='ets_contactform7'}" href="{$url_module|escape:'html':'UTF-8'}&save_message_update=0&id_contact={$contact.id_contact|intval}">
                                                <i class="material-icons action-enabled">{l s='check' mod='ets_contactform7'}</i>
                                            </a>
                                            ...
                                            {/if}
                                        {else}
                                            <a title="{l s='Enable' mod='ets_contactform7'}" href="{$url_module|escape:'html':'UTF-8'}&save_message_update=1&id_contact={$contact.id_contact|intval}">
                                                <i class="material-icons action-disabled">{l s='clear' mod='ets_contactform7'}</i>
                                            </a>
                                            {if $contact.count_message}
                                     ...
                                     <td class="text-center ctf_active">
                                        {if $contact.active}
                                            <a  href="{$url_module|escape:'html':'UTF-8'}&active_update=0&id_contact={$contact.id_contact|intval}">
                                                <i class="material-icons action-enabled">{l s='check' mod='ets_contactform7'}</i>
                                            </a>
                                        {else}
                                            <a href="{$url_module|escape:'html':'UTF-8'}&active_update=1&id_contact={$contact.id_contact|intval}">
                                                <i class="material-icons action-disabled">{l s='clear' mod='ets_contactform7'}</i>
                                            </a>
                                        {/if}
                                    </td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="position: absolute; transform: translate3d(-164px, 35px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                   {if $contact.enable_form_page}
                                                    ...
                                                    {/if}
                                                    <a  href="{$link->getAdminLink('AdminContactFormMessage')|escape:'html':'UTF-8'}&id_contact={$contact.id_contact|intval}" class="dropdown-item product-edit" title="{l s='Views message' mod='ets_contactform7'}">
