...
<div class="hidden" id="tag-generator-panel-file">
    <form data-id="file" class="tag-generator-panel" action="">
        ...
        <fieldset>
        <legend>{l s='Generate a form-tag for a file uploading field. For more details, see' mod='ets_contactform7'} <a href="{$link_basic|escape:'html':'UTF-8'}/modules/ets_contactform7/help/index.html#!/file-upload" target="_blank">{l s='File Uploading and Attachment' mod='ets_contactform7'}</a>.</legend>
