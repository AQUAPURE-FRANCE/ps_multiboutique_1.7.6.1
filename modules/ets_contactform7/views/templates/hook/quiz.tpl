...
<div id="tag-generator-panel-quiz" class="hidden">
    <form action="" class="tag-generator-panel" data-id="quiz"><div class="control-box">
        <fieldset>
        <legend>{l s='Generate a form-tag for a question-answer pair. For more details, see' mod='ets_contactform7'} <a href="{$link_basic|escape:'html':'UTF-8'}/modules/ets_contactform7/help/index.html#!/quiz" target="_blank">{l s='quiz' mod='ets_contactform7'}</a>.</legend>
