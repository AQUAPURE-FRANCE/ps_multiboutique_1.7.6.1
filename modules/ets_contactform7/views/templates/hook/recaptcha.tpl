    ...
    {if Configuration::get('ETS_CFT7_SITE_KEY') && Configuration::get('ETS_CFT7_SECRET_KEY')}
        <form data-id="recaptcha" class="tag-generator-panel" action="">
            <div class="control-box">
                <fieldset>
                <legend>{l s='Generate a form-tag for a reCAPTCHA widget. For more details, see' mod='ets_contactform7'} <a href="{$link_basic|escape:'html':'UTF-8'}/modules/ets_contactform7/help/index.html#!/recaptcha" target="_blank">{l s='reCAPTCHA' mod='ets_contactform7'}</a>.</legend>
