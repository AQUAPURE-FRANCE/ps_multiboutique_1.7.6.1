...
<div class="control-box">
    <fieldset>
    <legend>{l s='Generate a form-tag for a CAPTCHA widget. For more details, see' mod='ets_contactform7'} <a href="{$link_basic|escape:'html':'UTF-8'}/modules/ets_contactform7/help/index.html#!/captcha" target="_blank">{l s='image captcha' mod='ets_contactform7'}</a>.</legend>
