...
class WPCF7_FormTagsManager {
    ...
    public function set_instance()
    {
        ...
        etscf7_add_form_tag( 'recaptcha', 'etscf7_recaptcha_form_tag_handler',
			array( 'display-block' => true ) );
        etscf7_add_form_tag( 'captcha', 'etscf7_captcha_form_tag_handler',
			array('name-attr' => true, 'display-block' => true ) );
        etscf7_add_form_tag( 'response', 'etscf7_response_form_tag_handler',
		array( 'display-block' => true ) );
		...
		'etscf7_text_form_tag_handler', array( 'name-attr' => true ) );
        etscf7_add_form_tag( array( 'textarea', 'textarea*' ),
		'etscf7_textarea_form_tag_handler', array( 'name-attr' => true ) );
    }
}
