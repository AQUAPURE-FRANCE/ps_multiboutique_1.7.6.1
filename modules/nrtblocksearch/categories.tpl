...
<div class="select">
    <select name="category_filter" id="category_filter" class="form-control" style="display:none;">
        <option value="0"  {if $current_category == 0}selected="selected"{/if}>{l s='All Categories' mod='nrtblocksearch'}</option>
    ...
    <div class="select-styled">{l s='All Categories' mod='nrtblocksearch'}</div>
    </div>
{/if}
