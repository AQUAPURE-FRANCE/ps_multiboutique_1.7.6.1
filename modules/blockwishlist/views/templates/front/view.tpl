            ...
            <li id="wlp_{$product.id_product}_{$product.id_product_attribute}"  class="col-md-3 col-sm-4 col-xs-6 address {if $smarty.foreach.i.index % 2}alternate_{/if}item">
                <div class="clearfix">
                    ...
                    {/if}
                        ...
                        <div class="priority">{l s='Priority' mod='blockwishlist'}:<span>{$product.priority_name}</span></div>
                    </div>
                    </div>
                </div>
                <div class="btn_action">
                    <a class="button_small btn clear" href="{$link->getProductLink($product.id_product,  $product.link_rewrite, $product.category_rewrite)|escape:'html'}" title="{l s='View' mod='blockwishlist'}" rel="nofollow">{l s='View' mod='blockwishlist'}</a>
