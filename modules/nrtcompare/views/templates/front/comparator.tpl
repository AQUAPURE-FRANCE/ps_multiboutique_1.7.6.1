...
<header class="page-header">
	<h2>{l s='Products Comparison' mod='nrtcompare'}</h2>
</header>
{if $list_products}
			<table>
					<tr>
                        ...
                        {foreach from=$list_products item="product"} 
                            <td class="comparison_infos product-{$product.id_product}">
                                ...
                                <a href="javascript:void(0)" class="remove_to_compare" data-id-product="{$product.id_product}" title="{l s='Remove to Compare' mod='nrtcompare'}">
