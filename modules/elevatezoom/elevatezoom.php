...
class ElevateZoom extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('ElevateZoom');
	...
	public function install()
	{
		...
		return (parent::install() &&
			...
			Configuration::updateValue('ELEVATEZOOM_TINT_OPACITY', 0.2) &&
			
			Configuration::updateValue('ELEVATEZOOM_LENS_SHAPE', 'square') &&
			Configuration::updateValue('ELEVATEZOOM_LENS_SIZE', 345) &&
				
			Configuration::updateValue('ELEVATEZOOM_EXTRA_PARAMS', 'borderSize:1,borderColour:\'#e2e2e2\', zoomWindowWidth:505, zoomWindowHeight:505, zoomLevel:0.5,lensBorderSize:1') &&
    ...
    private function _createTab()
    {
        ...
        $tab = new Tab();
        $tab->active = 1;
        $tab->class_name = "AdminNrtElevatezoom";
        $tab->name = array();
        foreach (Language::getLanguages() as $lang){
            $tab->name[$lang['id_lang']] = "Manage Elevatezoom";
        }
    ...
    {
        $id_tab = Tab::getIdFromClassName('AdminNrtElevatezoom');
        $parentTabID = Tab::getIdFromClassName('AdminNrtMenu');
	...
	public function displayForm()
	{
		...
		<form action="'.Tools::safeOutput($_SERVER['REQUEST_URI']).'" method="post">
			<fieldset>
				...
				<div class="margin-form">
					<input id="zoom_extra_params" type="text" name="zoom_extra_params" value="'.str_replace('"','\'',Configuration::get('ELEVATEZOOM_EXTRA_PARAMS')).'" style="width:250px" />
