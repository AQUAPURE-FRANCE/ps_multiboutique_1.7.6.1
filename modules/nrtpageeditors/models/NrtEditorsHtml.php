...
class NrtEditorsHtml extends ObjectModel
{
	public $title;
	public $html;
	...
	public function add($autodate = true, $null_values = false)
	{
		...
		$res &= Db::getInstance()->execute('
			INSERT INTO `'._DB_PREFIX_.'nrteditors_html` (`id_html`, `id_shop`)
	...
	public function delete()
	{
		...
		$tab = new NrtEditorsHtml((int)$this->id);

		$res &= Db::getInstance()->execute('
			DELETE FROM `'._DB_PREFIX_.'nrteditors_html`
	...
	public static function getHtmls()
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			FROM '._DB_PREFIX_.'nrteditors_html hs
			LEFT JOIN '._DB_PREFIX_.'nrteditors_htmlc hss ON (hs.id_html = hss.id_html)
			LEFT JOIN '._DB_PREFIX_.'nrteditors_htmlc_lang hssl ON (hs.id_html = hssl.id_html)
