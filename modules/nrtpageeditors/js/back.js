...
$('.first-rows-wrapper').on('sortupdate', function( event, ui ) {
	...
	{
		ui.item.parents('.nav-tabs-sortable').find('.nrtcontent-tab-li').each(function( index) {
...
$( '#buttons-sample' ).on( 'click', '.add-row-action', function() {
	...
	if (typeof nrt_fronteditors != 'undefined' && nrt_fronteditors)
		$parentElement.append( '<div data-element-type="1" data-depth="0" data-element-id="' + (++elementId) + '" class="row menu_row menu_row_element  nrtcontent_row nrtcontent-element first_rows menu-element menu-element-id-' + (elementId) + '">' + $( '#buttons-sample' ).html() + $( '#row-content-sample' ).html() + '</div>' );
	else
...
$( '.grid_editors' ).on( 'click', '.menu-element .add-row-action', function() {
	...
	if (typeof nrt_fronteditors != 'undefined' && nrt_fronteditors)
		$parentElement.append( '<div data-element-type="1" data-depth="' + depth + '" data-element-id="' + (++elementId) + '" class="row menu_row menu_row_element nrtcontent_row nrtcontent-element menu-element menu-element-id-' + (elementId) + '">' + $( '#buttons-sample' ).html() + ' </div>' );
	else
...
$( '.grid_editors' ).on( 'click', '.menu-element .add-tab-action', function() {
	...
	$parentElement.find('.nav-tabs').first().append( '<li data-element-id="' + (elementId) + '" data-element-type="3" class="nrtcontent-tab-li nrtcontent-tab-li-id-' + (elementId) + ' active"><a href="#nrtcontent-tab-id-' + (elementId) + '" data-toggle="tab">Tab ' + (elementId) + '<span class="dragger-handle-tab"><i class="icon-arrows "></i></span></a></li>' );
	$parentElement.find('.tab-content').first().append( '<div id="nrtcontent-tab-id-' + (elementId) + '" class="tab-pane   active nrtcontent-element-id-' + (elementId) + '"><div data-element-type="3" data-depth="' + depth + '" data-element-id="' + (elementId) + '" class="row menu_row menu_tabe menu_row_element menu-element menu-element-id-' + (elementId) + '">' + $( '#buttons-sample' ).html() + $( '#tab-content-sample' ).html() + ' </div></div>' );
...
$( '.grid_editors' ).on( 'click', '.menu-element .add-column-action', function() 
{
	...
	if (typeof nrt_fronteditors != 'undefined' && nrt_fronteditors)
		$parentElement.append( '<div data-element-type="2" data-depth="' + depth + '"  data-width-p="12" data-width-t="12" data-width-d="12" data-element-id="' + (++elementId) + '" class="col-xs-12 col-sm-12 col-md-12 nrtcontent-column nrtcontent-element menu_column menu-element menu-element-id-' + (elementId) + ' clearfix">' + $( '#buttons-sample' ).html() + $( '#column-content-sample' ).html() + '</div>' );
	else
...
$( '.grid_editors' ).on( 'click', '.menu-element .add-tabs-action', function() 
{
	...
	if (typeof nrt_fronteditors != 'undefined' && nrt_fronteditors)
		$parentElement.append( '<div data-element-type="4" data-depth="' + depth + '"  data-width-p="12" data-width-t="12" data-width-d="12" data-element-id="' + (++elementId) + '" class="col-xs-12 col-sm-12 col-md-12 nrtcontent-column nrtcontent-element menu_column menu_tabs menu-element menu-element-id-' + (elementId) + ' clearfix">' + $( '#buttons-sample' ).html() + $( '#column-content-sample' ).html() + '<ul class="nav nav-tabs nav-tabs-sortable"></ul><div class="tab-content"></div></div>' );
	else
...
$( '.grid_editors' ).on( 'click', '.remove-element-action', function() {
	...
	if($parent_element.data('element-type') == 3)
		$('.nrtcontent-tab-li-id-' + $parent_element.data('element-id')).remove();
...
$('button[name="submitNrtpageeditorsModule"]').on("click",function() {
