...
{block name="defaultForm"}
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                <div id="nrtthemecustomizer-tabs" class="col-lg-2">
...
{block name="label"}
    ...
    {if $input['name'] == "NRT_bodyBackgroundColor" || $input.name == "NRT_breadcrumbBackgroundImage"}
...
{block name="input"}
    ...
    {if $input.name == "NRT_bodyBackgroundImage" || $input.name == "NRT_backgroundImage" || $input.name == "NRT_breadcrumbBackgroundImage"}
