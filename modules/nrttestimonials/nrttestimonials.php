...
class Nrttestimonials extends Module {
	...
	public function __construct(){
		...
		$this->description = $this->l('Nrt Testimonials Module.');
		$this->_params =new NrtParams( $this->name, $this);
	}
	...
	public function install(){
		 if (parent::install() && $this->registerHook('header') && $this->registerHook('testimonials')) {
...
private function _deleteTab()
	...
	{	
		$this->context->controller->addJS(_MODULE_DIR_._NRT_TESTIMONIAL_FRONT_URL_.'js/testimonials.js');
	}
	public function hookTestimonials($params){
		$testLimit = $this->getParams()->get('testLimit');
		$get_testimonials = NrtTestimonial::getAllTestimonials($testLimit);
		...
		$mediaUrl = $this->context->link->getMediaLink(_MODULE_DIR_.$this->name.'/img/');
		$video_post = _MODULE_DIR_._NRT_TESTIMONIAL_FRONT_URL_.'img/video.jpg';
		$video_youtube = _MODULE_DIR_._NRT_TESTIMONIAL_FRONT_URL_.'img/youtube.jpg';
		$video_vimeo = _MODULE_DIR_._NRT_TESTIMONIAL_FRONT_URL_.'img/vimeo.jpg';
                $background = "";
		...
		return $this->display(__FILE__, _NRT_TESTIMONIAL_VIEW_FRONT_.'testimonials_random.tpl');
	}
}
