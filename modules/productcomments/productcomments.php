...
class ProductComments extends Module
{
    ...
    public function install($keep = true)
    {
        ...
        if (parent::install() == false ||
            ...
            !$this->registerHook('displayProductReviews') || //Accessorie list miniature
            !$this->registerHook('displayProductTitleReviews') || //Product Title Reviews
            !$this->registerHook('displayProductTabExtra') || //Product Tab
            !$this->registerHook('displayProductTabContentExtra') || //Product Tab Content
    ...
    public function uninstall($keep = true)
    {
        if (!parent::uninstall() || ($keep && !$this->deleteTables()) ||
            ...
            !$this->unregisterHook('displayProductTabExtra') ||
            !$this->unregisterHook('displayProductTabContentExtra') ||
            !$this->unregisterHook('displayProductListReviews') ||
            !$this->unregisterHook('displayProductReviews') ||
            !$this->unregisterHook('displayProductTitleReviews')) {
            return false;
        }
    ...
    public function hookDisplayProductTabExtra($params)
    {
        ...
        return $this->context->smarty->fetch('module:productcomments/views/templates/hook/product-tab.tpl');
    }
   
    public function hookDisplayProductTabContentExtra($params)
    {
        /** @var ProductLazyArray $product */
        $product = $params['product'];
        /** @var ProductCommentRepository $productCommentRepository */
        ...
        return $this->context->smarty->fetch('module:productcomments/views/templates/hook/product-tab-content.tpl') . $this->renderProductCommentModal($params['product']);
    }
...
//           $this->context->smarty->fetch('module:productcomments/views/templates/hook/accessory-list-reviews.tpl'),
...
//        }
    ...
    /**
     * Display average grade and buttons under the product Title
     *
     * @param $params
     *
     * @return string
     ...
     * @throws SmartyException
     */
    public function hookDisplayProductTitleReviews($params)
    {
        /** @var ProductLazyArray $product */
        $product = $params['product'];
        /** @var ProductCommentRepository $productCommentRepository */
        ...
        return $this->context->smarty->fetch('module:productcomments/views/templates/hook/product-title-reviews.tpl');
    }
