<h1 class="page-heading-text">{$instagram_user.full_name} {l s='Instagram' mod='nrtinstagram'}</h1>
...
<div class="row">
	...
	<div class="col-xs-9">
		<p>
			<strong>{$instagram_user.posts}</strong> {l s='post' mod='nrtinstagram'} /
			<strong>{$instagram_user.followed_by}</strong> {l s='followed by' mod='nrtinstagram'} /
			<strong>{$instagram_user.follows}</strong> {l s='follows' mod='nrtinstagram'}
		</p>
...
<div class="text-center">
	<a href="https://www.instagram.com/{$instagram_user.username}/" class="btn btn-primary" target="_blank">
		{l s='See all our Instagram pics' mod='nrtinstagram'}
	</a>
</div>