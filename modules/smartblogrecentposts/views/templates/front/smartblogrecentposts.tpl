        ...
        {foreach from=$posts item="post"}
             ...
             <li>
               ...
               <span class="info">{$post.created|date_format:"%b %d, %Y"}</span>
                 {*<a class="read-more"  title="{l s='Read more' mod='smartblogrecentposts'}" href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}">{l s='Read more' mod='smartblogrecentposts'}</a>*}
               	</div>
             </li>
         {/foreach}
            </ul>
